      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-1.5 sm:gap-0 sm:items-center justify-between text-[10px] font-bold uppercase">
          ...
          {jogo.status === 'AO_VIVO' ? (
            ...
            <span className="self-start sm:self-auto text-brand-blue-vibrant bg-brand-blue-dark/85 border border-brand-blue-accent/30 px-2 py-0.5 rounded flex items-center gap-1">
        ...
        <div className="pt-2 border-t border-slate-900 flex flex-col xs:flex-row gap-2 xs:gap-0 justify-between items-start xs:items-center text-xs">
          ...
          {token && !isReadonly && !isBlocked && (
            <button
              ...
              disabled={isSaving}
              className="group flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-brand-blue-accent to-brand-blue hover:scale-105 hover:shadow-md hover:shadow-brand-blue-accent/10 text-white font-bold rounded-lg transition transform active:scale-95 text-[11px] w-full xs:w-auto justify-center"
            >
